...
<?php if (!empty($data)): ?>
    <div class="single-car-data box-define">
        <h4 style="text-transform: capitalize;">specifications</h4>
        <?php
        ...
        <div class="desc-container">
            <h4 style="text-transform: capitalize;">vehicle description</h4>
            ...
            <script type="text/javascript">
                ...
                // simple script to grab the description if it is formatted and written on the individual car page
                var desc = $('.wpb_tab');
                var text = $('#vehicle-description');

                if ( desc.length > 0 ) {
                   desc = desc.children().children().children();
                    if ( $(desc[0]).is("p") ) {
                        desc = desc[0];
                        desc = $(desc).text();
                        $(text).text(desc);
